...
// Usage Examples
export const MarkdownExample: React.FC = () => {
...
[Visit React](https://reactjs.org)
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Markdown Renderer Examples</h1>

      {/* Render from content prop */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-4">From Content String:</h2>
        <MarkdownRenderer content={sampleMarkdown} />
      </div>

      {/* Render from file */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-4">From README File:</h2>
